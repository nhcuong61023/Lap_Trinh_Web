...
<body>
  ...
  <div class="details">
    ...
    <h2 class="detailsy"><?php echo $p_price . '.' . CURRENCY; ?> <del>1299.<?php echo CURRENCY; ?></del>
    ...
    <div class="offers">
      <h2>BEST OFFERS </h2>
      <h3>Best Price: <div class="orange"> 279.<?php echo CURRENCY; ?></div>
      </h3>
      <ul>
        <li>Applicable on: Orders above 2499.<?php echo CURRENCY; ?> (only on first purchase)</li>
        <li>Coupon code: <b> HRXEID400</b></li>
        <li>Coupon Discount: 400.<?php echo CURRENCY; ?> off (check cart for final savings)</li>
      </ul>
      <a href="#" class="viewproducts">View Eligible Products</a>
      <h2 class="emi">EMI option available</h2>
      <ul>
        <li>EMI starting from 32.<?php echo CURRENCY; ?>/month</li>
      </ul>
      <br>
