...
<body>
  ...
  <div class="banner">
    ...
    <div class="btext">
      <div class="btext_content">
        <h2 style="margin-left: 20px;">HRX COLLECTION</h2>
		<h1 style="margin-left: 30px;">FIND YOUR EDGE</h1>
		<h3 style="margin-left: 40px;">Everything you need throughout your stylist journey</h3>
      </div>
    </div>
  </div>
  ...
  <div class="index_pro_show">
    ...
    <div class="p_show">
      <?php
      $sql = "select * from product order by p_img1 desc limit 10";
